            ...
            if state == "upload_step_1_meta":
                ...
                try:
                    ...
                    def process_setting(c_key, val_str):
                        ...
                        elif c_key == "about message": updated_settings["about_message"] = val_str
    ...
    <div id="detail-view" class="secondary-view">
        ...
        <div class="content-card">
            ...
            <div class="action-buttons-container">
                ...
                <a id="btn-story-access" href="#" target="_blank" class="action-btn btn-access" onclick="handleMinimize()">🎶 Listen/Access Story</a>
            </div>
        </div>
    </div>

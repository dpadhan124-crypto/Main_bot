...
async def plan_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("💳 Pay Now", url=safe_url(bot_settings.get("https://rb.gy/81kgkx", "")))],
        [InlineKeyboardButton("📤 Send Screenshot", url=safe_url(bot_settings.get("https://t.me/dps_supportbot", "")))]
    ]
            ...
            if matched_item:
                ...
                if c_type in ["free", "verify"] and not is_user_premium:
                    if not VERIFICATION_STATE.get((user_id, token_10), False):
                        # Construct a clean URL directly to our web app routing to hide raw Arolinks from Long Press
...
# Route to intercept Arolinks URL generation. This effectively hides the api generation 
# logic, providing a clean redirect link inside telegram button so long presses expose nothing but your host.
